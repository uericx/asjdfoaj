<?php namespace App\Http\Controllers;
	...
	class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Descripción','name'=>'descripcion','type'=>'textarea','validation'=>'required|min:1|max:500','width'=>'col-sm-9'];
	        ...
	        */
	        ...
	        $this->sub_module[] = ['label'=>'Subcategorías','path'=>'subcategories','parent_columns'=>'nombre','foreign_key'=>'category_id','button_color'=>'success','button_icon'=>'fa fa-th-list'];
